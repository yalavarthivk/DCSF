...
from .Synth_reader import synth_TSDreader
...
class TsDataReader(synth_TSDreader):
...
class Synth_0_9(TsDatasetBuilder):
    """In hospital mortality task dataset of the MIMIC-III benchmarks."""
    VERSION = tfds.core.Version('1.0.1')
    MANUAL_DOWNLOAD_INSTRUCTIONS = """\
    manual_dir should contain the file `Synth_0_9.tar.gz`\
    """
    ...
    def _info(self):
        return TsDatasetInfo(
            ...
            values_names=synth_TSDreader.values,
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        data_file = join(
            dl_manager.manual_dir, 'Synth_0_9.tar.gz')
