...
from .PS_reader import PS_TSDreader
...
class TsDataReader(PS_TSDreader):
...
class PS_async(TsDatasetBuilder):
    """In hospital mortality task dataset of the MIMIC-III benchmarks."""
    VERSION = tfds.core.Version('1.0.1')
    MANUAL_DOWNLOAD_INSTRUCTIONS = """\
    manual_dir should contain the file `PhonemeSpectra_async.tar.gz`\
    """
    ...
    def _info(self):
        return TsDatasetInfo(
            ...
            values_names=PS_TSDreader.values,
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        data_file = join(
            dl_manager.manual_dir, 'PhonemeSpectra_async.tar.gz')
